        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav" id="sidebarNav">
                ...
                <a href="{{ route('inventory.stock.index') }}"
                    class="nav-item {{ request()->routeIs('inventory.stock.index') || request()->routeIs('inventory.stock.movements') ? 'active' : '' }}"
                ...
                <a href="{{ route('inventory.stock.low') }}"
                    class="nav-item {{ request()->routeIs('inventory.stock.low') ? 'active' : '' }}"
                    data-tooltip="Peringatan Stok">
                    <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                    <span class="nav-label">Peringatan Stok</span>
                    @php $badgeLowStock = \App\Models\Product::with('variants')->get()->filter(fn($p) => $p->isLowStock())->count(); @endphp
                    @if($badgeLowStock > 0)
                    <span class="nav-badge" style="background:#EF4444;">{{ $badgeLowStock }}</span>
                    @endif
                </a>
                ...
                <a href="{{ route('customers.index') }}"
                    class="nav-item {{ request()->routeIs('customers.index') || request()->routeIs('customers.show') || request()->routeIs('customers.edit') || request()->routeIs('customers.create') ? 'active' : '' }}"
                ...
                <a href="{{ route('expenses.index') }}"
                    ...
                    data-tooltip="Biaya & Pengeluaran">
                    <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <nav class="mobile-nav">
        <div class="mobile-nav-inner">
            ...
            <a href="{{ route('pos.index') }}" class="mobile-nav-item {{ request()->routeIs('pos.*') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 11h.01M12 11h.01M15 11h.01M4 20h16a2 2 0 002-2V8a2 2 0 00-2-2h-5.586a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 0011.586 3H4a2 2 0 00-2 2v13a2 2 0 002 2z" />
                </svg>
                Kasir
            </a>
            @endif
